...
# ส่วนที่ 4 แสดงผลการแปลค่า BMI และข้อมูลผู้พัฒนา
if bmi < 18.5:
    st.info("คุณอยู่ในเกณฑ์: ผอม / น้ำหนักน้อยกว่าปกติ 🦴")
elif bmi < 23.0:
    st.success("คุณอยู่ในเกณฑ์: น้ำหนักปกติ (สุขภาพดี) 😊")
elif bmi < 25.0:
    st.warning("คุณอยู่ในเกณฑ์: ท้วม / น้ำหนักเกิน 😅")
else:
    st.error("คุณอยู่ในเกณฑ์: อ้วน / น้ำหนักเกินมาตรฐาน 🚨")

st.write("---")
st.caption("พัฒนาโดย: [นาย ธนกฤต ธาตุทอง] เลขที่ [14] ห้อง [4/2]")

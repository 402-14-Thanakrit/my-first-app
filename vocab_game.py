...
# 1. กำหนดค่าเริ่มต้นใน session_state ถ้ายังไม่มี (จุดที่ 1)
...
# เพิ่มช่องรับคำตอบข้อ 3 และ 4 (จุดที่ 6)
ans3 = st.text_input(
    "ข้อ 3: Monkeys like to eat `b _ n _ n _`. 🍌",
    value=st.session_state.ans3_val,
)
ans4 = st.text_input(
    "ข้อ 4: An `o _ a n _ e` is rich in Vitamin C. 🍊",
...
st.divider()
st.write("นายธนกฤต ธาตุทอง เลขที่ 14 ม.4/2")
